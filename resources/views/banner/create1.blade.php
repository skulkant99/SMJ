                   ...
                   <div class="page-body">
                       <div class="card tabs-card">					
                            ...
                            <div class="card-header">
                                <h4>Create Product Banner</h4>
                                <p class="text-muted m-b-10">Detail</p>
                                <ul class="breadcrumb-title b-t-default p-t-10">
                                    <li class="breadcrumb-item"><a href="#!">Product Banner</i></a></li>
                                    <li class="breadcrumb-item"><a href="#!">Create Product Banner</a></li>
                                </ul>					
                            </div>
                           
                           <!-- block -->
                            <div class="card-block" id="reload_add">
                                <form method="post" action="{{url('backoffice/banner/create1')}} "enctype="multipart/form-data">
                                {!! csrf_field() !!}
