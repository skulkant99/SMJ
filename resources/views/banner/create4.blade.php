                   ...
                   <div class="page-body">
                       <div class="card tabs-card">					
                            ...
                            <div class="card-header">
                                <h4>Create Activities Banner</h4>
                                <p class="text-muted m-b-10">Detail</p>
                                <ul class="breadcrumb-title b-t-default p-t-10">
                                    <li class="breadcrumb-item"><a href="#!">Activities Banner</i></a></li>
                                    <li class="breadcrumb-item"><a href="#!">Create Activities Banner</a></li>
                                </ul>					
                            </div>
                           
                           <!-- block -->
                            <div class="card-block" id="reload_add">
                                <form method="post" action="{{url('backoffice/banner/create4')}} "enctype="multipart/form-data">
                                {!! csrf_field() !!}
