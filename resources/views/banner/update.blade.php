                       ...
                       <div class="card tabs-card">					
                            ...
                            <div class="card-header">
                                ...
                                <ul class="breadcrumb-title b-t-default p-t-10">
                                    <li class="breadcrumb-item"><a href="#!">Banner </i></a></li>
                           ...
                           <!-- block -->
                                    ...
                                    <div class="card-block" id="reload_add">
                                        <form action="{{url('backoffice/banner/update')}}" method="post" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        ...
                                        <div class="col-sm-12"> 
                                            ...
                                            <br><label style="color:red"><b>*ขนาดรูปภาพ 1920px*480px</b></label>
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label text-right"></label>											
                                                <div class="col-sm-4">
                                                    <img src="{{URL::asset('/assets/images/banner')}}/{{$data->banner_img}}" id="imgfile" class="img-fluid img-responsive" style="width:200px;height:200px;" >                                          
                                                    <input type="hidden" name="oldimg" value="{{$data->banner_img}}" >
                                                </div>
                                            </div>
                                            <div class="form-group row"> 
