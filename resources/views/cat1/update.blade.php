                ...
                <div class="page-body">
                    <div class="card tabs-card">
                        ...
                        <div class="card-block" id="reload_add">
                            <form action="{{url('backoffice/cat1/update')}}" method="post"
                                enctype="multipart/form-data">
                                {{ csrf_field() }}

                                <input type="hidden" name="id" value="{{$data->categorysub_id}}">
                                ...
                                <input type="text" class="form-control" name="name_th"
                                    value="{{$data->categorysub_name_th}}"><br>

                                <label>SUBCATEGORY (English) :</label><span style="color:red"></span>
                                <input type="text" class="form-control" name="name_en"
                                    value="{{$data->categorysub_name_en}}"><br>
