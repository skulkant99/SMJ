                ...
                <div class="page-body">
                    <div class="card tabs-card">
                        ...
                        <div class="card-block" id="reload_add">
                            <form action="{{url('backoffice/cat2/create')}}" method="post"
                                ...
                                <select class="form-control" name="subcategory" id="subcategory">
                                    ...
                                    <option value="{{$type->categorysub_id}}">{{$type->categorysub_name_en}} /
                                        {{$type->categorysub_name_th}}</option>
                                    @endforeach
                                    @endif
                                </select><br>
