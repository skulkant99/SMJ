                               ...
                               <div class="row">
                                   <div class="col-md-12">
                                       <div class="text-right">
										   ...
										   <button type="button" class="btn btn-dark" data-toggle="modal" data-target="#favoritesModal"><i class="fa fa-plus-square"></i> Add</button>                                                                           
                                           </div>       
                                       </div>
                                   </div>          
                               </div>
                               ...
                               <div class="dt-responsive table-responsive">        
                                   <table id="datatables" class="table table-striped table-bordered" width="100%">
                                       <thead>
                                        ...
                                        <tr>  
                                            <th class="text-center">SUB CATEGORY1</th>          
                                            <th class="text-center">SUB CATEGORY2</th>
                                       ...
                                       @if($data)
                                            ...
                                            <td>{{$key->categorysub_2_name_en}} / {{$key->categorysub_2_name_th}}</td>				
                                            <td class="text-center">
                                            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#editModal{{$key->categorysub_2_id}}"> Update</button>
                                                <button type="button" class="btn btn-danger" onclick="del_categorysub2({{$key->categorysub_2_id}})"><i class="icon-trash"></i> Delete</button>
                                              </td>
                                            </tr>
                                          @endforeach  
...
<div class="modal fade" id="favoritesModal" 
          ...
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-header">
                ...
                id="favoritesModalLabel">Create Category</h4>
              </div>
                <form method="post" action="{{url('ajax_createsub2')}}" enctype="multipart/form-data" >
                    {{ csrf_field() }}
                      ...
                      <select class="form-control" name="type">
                          ...
                          @foreach($data2 AS $type)
                                      <option value="{{$type->categorysub_id}}">{{$type->categorysub_name_en}} / {{$type->categorysub_name_th}}</option>
                          @endforeach
                          @endif
                      </select><br>
                    ...
                    <input type="text" class="form-control" name="name_en" ><br>
                      ...
                      <div class="modal-footer">
                        <button type="button" 
                           ...
                           data-dismiss="modal">Cancal</button>&nbsp;&nbsp;&nbsp;
        ...
        @if($data)
          ...
          <div class="modal fade" id="editModal{{$key->categorysub_2_id}}" 
             tabindex="-1" role="dialog" 
             aria-labelledby="favoritesModalLabel">
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" 
                  ...
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" 
                id="favoritesModalLabel">Update Category</h4>
              </div>
                <form method="post" action="{{url('ajax_updatecategorysub2')}}" enctype="multipart/form-data" >
                    {{ csrf_field() }}
                    ...
                    <input type="hidden" name="id" value="{{$key->category_id}}">
                      ...
                      <label>Sub Category (ภาษาไทย) :</label><span style="color:red"></span>
                      <input type="text" class="form-control" value="{{$key->categorysub_2_name_th}}" name="name_th"><br>

                      <label>Sub Category  (English) :</label><span style="color:red"></span>
                      <input type="text" class="form-control" value="{{$key->categorysub_2_name_en}}" name="name_en" ><br>
...
function del_categorysub2(id){
		bootbox.confirm({
			...
			callback: function (result){
				if(result == true){
					window.location.href="categorysub2/del/"+id+"";
				}
			}
		});
  }
