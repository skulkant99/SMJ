                       ...
                       <div class="card tabs-card">					
                            ...
                            <div class="card-header">
                                ...
                                <ul class="breadcrumb-title b-t-default p-t-10">
                                    ...
                                    <li class="breadcrumb-item"><a href="#!">Update KNOWLEDGE</a></li>
                                </ul>					
                            </div>
                           ...
                           <!-- block -->
                                    ...
                                    <div class="card-block" id="reload_add">
                                        <form action="{{url('backoffice/knowledge/update')}}" method="post" enctype="multipart/form-data">
                                        {{ csrf_field() }}

                                        <input type="hidden" name="id" value="{{$data->knowledge_id}}">

                                     
                                        <label>Date :</label><span style="color:red"></span>
                                        <input type="date" class="form-control" name="date" value="{{$data->knowledge_date}}" placeholde="Date"><br>
                                        ...
                                        <!-- ขวา-->
                                            ...
                                            <input type="text" class="form-control" name="topic_th" value="{{$data->knowledge_topic_th}}" placeholder="ภาษาไทย"><br>
                                            
                                            <label>Datail (ภาษาไทย) :</label><span style="color:red"></span>
                                            <textarea type="text" id="detail_th" rows="4" cols="50" class="form-control"  name="detail_th" placeholder="Detail">{{$data->knowledge_detail_th}}</textarea><br>
                                         ...
                                         <!-- ซ้าย-->
                                            ...
                                            <input type="text" class="form-control" name="topic_en" value="{{$data->knowledge_topic_en}}" placeholder="English"><br>
                                            
                                            <label>Detail (English) :</label><span style="color:red"></span>
                                            <textarea type="text" id="detail_en" rows="4" cols="50" class="form-control"  name="detail_en" placeholder="Detail">{{$data->knowledge_detail_en}}</textarea><br>
                                        ...
                                        <div class="col-sm-12"> 
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-4">
                                                    <img src="{{URL::asset('/assets/images/knowledge')}}/{{$data->knowledge_img}}" id="imgfile" class="img-fluid img-responsive" style="width:200px;height:200px;" >                                          
                                                    <input type="hidden" name="oldimg" value="{{$data->knowledge_img}}" >    
                                                </div>
                                            </div>
                                            <div class="form-group row"> 
