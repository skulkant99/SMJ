                       ...
                       <div class="card tabs-card">					
                            ...
                            <div class="card-header">
                                ...
                                <ul class="breadcrumb-title b-t-default p-t-10">
                                    ...
                                    <li class="breadcrumb-item"><a href="#!">Create PARTNER</a></li>
                                </ul>					
                            </div>
                           ...
                           <!-- block -->
                                    ...
                                    <div class="card-block" id="reload_add">
                                        <form action="{{url('backoffice/partner/create')}}" method="post" enctype="multipart/form-data">
                                        {{ csrf_field() }}


                                        <label>Link :</label><span style="color:red"></span>
                                        <input type="text" class="form-control" name="link" placeholder=""><br>
                                        ...
                                        <div class="col-sm-12"> 
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-4">
                                                    <img src="{{URL::asset('public/backend/img/wait_img.png')}}" id="imgfile" class="img-fluid img-responsive" style="width:780px;height:200px;" >                                          
                                                </div>
                                            </div>
                                            <div class="form-group row"> 
