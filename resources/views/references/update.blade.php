                       ...
                       <div class="card tabs-card">					
                            ...
                            <div class="card-header">
                                ...
                                <ul class="breadcrumb-title b-t-default p-t-10">
                                    ...
                                    <li class="breadcrumb-item"><a href="#!">Update REFERENCES</a></li>
                                </ul>					
                            </div>
                           ...
                           <!-- block -->
                                    ...
                                    <div class="card-block" id="reload_add">
                                        <form action="{{url('backoffice/references/update')}}" method="post" enctype="multipart/form-data">
                                        {{ csrf_field() }}

                                        <input type="hidden" name="id" value="{{$data->references_id}}">
                                        ...
                                        <select class="form-control" name="type">
                                            ...
                                            @foreach($data2 AS $key)
                                                        <option value="{{$key->type_id}}"{{$data->references_type == $key->type_id ? 'selected' : ''}}>{{$key->type_name_th}} / {{$key->type_name_en}}</option>
                                            @endforeach
                                            @endif
                                           </select><br>
                                        ...
                                        <!-- ขวา-->
                                            ...
                                            <input type="text" class="form-control" name="name_th" value="{{$data->references_name_th}}" placeholder="ภาษาไทย"><br>
                                            
                                            
                                            <label>Detail (ภาษาไทย) :</label><span style="color:red"></span>
                                            <textarea type="text" id="detail_th" rows="4" cols="50" class="form-control"  name="detail_th" placeholder="Detail">{{$data->references_detail_th}}</textarea><br>
                                         ...
                                         <!-- ซ้าย-->
                                            ...
                                            <input type="text" class="form-control" name="name_en" value="{{$data->references_name_en}}" placeholder="English"><br>
                                            
                                            <label>Datail (English) :</label><span style="color:red"></span>
                                            <textarea type="text" id="detail_en" rows="4" cols="50" class="form-control" name="detail_en" placeholder="Detail">{{$data->references_detail_en}}</textarea><br>
                                        ...
                                        <div class="col-sm-12"> 
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-4">
                                                    <img src="{{URL::asset('/assets/images/references')}}/{{$data->references_img}}" id="imgfile" class="img-fluid img-responsive" style="width:200px;height:200px;" >                                          
                                                </div>
                                            </div>
                                            <div class="form-group row"> 
                                        ...
                                        <div class="row">
                                        <div class="col-md-6">
                                        <table class="table table-bordered" id="newsimgtable"> 
                                        <thead>
                                            <tr>   
                                        ...
                                        <tbody id="referencesimg">

                                        @if($referencesimg)
                                        @foreach($referencesimg AS $key) 
                                        <tr> 

                                                    <td class="text-center"> 
                                                    <div class="col-md-11">	          
                                                            <input type="" class="form-control"  value="{{$key->referencesimg_name_th}}" ><br>
                                                    </div>
                                                    <td class="text-center"> 
                                                    <div class="col-md-11">	          
                                                        <img src="{{asset('assets/images/referencesimg')}}/{{$key->referencesimg_img}}" width="120px" height="90px" />
                                                    </div>
                                                    
                                                    <td class="text-center"> 
                                                    <div class="col-md-1">	
                                                        <button type="button" class="btn btn-danger" onclick="delete_referencesimg({{$key->referencesimg_id}})">delete</button>
                                                    </div>
...
<script>
    $(document).ready(function() {
        ...
        function setimage(ele,row){
                ...
                function delete_referencesimg(id){
                    bootbox.confirm({
                        title: "ยืนยัน?",
                        ...
                        callback: function (result){
                            if(result == true){
                                $.get('{{url("backoffice/referencesimg_del")}}'+'/'+id,function(data){
                                    $('#newsimgtable').load(document.URL + ' #newsimgtable');
                                });
