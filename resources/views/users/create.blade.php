                       ...
                       <div class="card tabs-card">					
                           ...
                           <!-- block -->
                            <div class="card-block" id="reload_add">
                                <form method="post" action="{{url('backoffice/users/create/users')}} "enctype="multipart/form-data">
                                {!! csrf_field() !!}
                                    ...
                                    {{-- ฟอร์ม--}}  
											...
											<input type="text" class="form-control" name="name" placeholder="Firstname - Lastname"><br>

											<label>E-mail :</label><span style="color:red">*</span>
											<input type="text" class="form-control" name="email" placeholder="E-mail"><br>

											<label>Telephone :</label>
											<input type="text" class="form-control" name="phone" placeholder="Telephone"><br>

											<label>Password :</label>
											<input type="text" class="form-control" name ="psw" placeholder="Password"><br>
