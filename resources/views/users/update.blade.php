                       ...
                       <div class="card tabs-card">					
                            ...
                            <div class="card-header">
                                ...
                                <ul class="breadcrumb-title b-t-default p-t-10">
                                    <li class="breadcrumb-item"><a href="#!">USERS</i></a></li>
                                    <li class="breadcrumb-item"><a href="#!">Update USERS</a></li>
                                </ul>					
                            </div>
                           ...
                           <!-- block -->
                                    ...
                                    <div class="card-block" id="reload_add">
                                        <form action="{{url('backoffice/users/update/users')}}" method="post" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        <input type="hidden" name="id" value="{{$data->id}}">
                                            ...
                                            <label>Firstname - Lastname :</label><span style="color:red">*</span>
											<input type="text" class="form-control" value="{{$data->name}}" name="name" placeholder="Firstname - Lastname"><br>

											<label>E-mail :</label><span style="color:red">*</span>
											<input type="text" class="form-control" value="{{$data->email}}" name="email" placeholder="E-mail"><br>

											<label>Telephone :</label>
											<input type="text" class="form-control" value="{{$data->phone}}" name="phone" placeholder="Telephone"><br>

                                            <label>New Password :</label>
											<input type="text" class="form-control" name ="psw" placeholder="NEW PASSWORD"><br>
                                            <input type="hidden" value="{{$data->password}}" name="oldpsw">
